...
dhtmlxTreeGrid v.8.3.10 Professional
...
var html_1 = __webpack_require__(2);
var ts_message_1 = __webpack_require__(75);
...
function getRenderConfig(obj, data, wrapperSizes) {
    ...
    var currentSpans = spans.filter(function (_a) {
        var _b = _a.$rowsVisibility, $rowsVisibility = _b === void 0 ? [] : _b, _c = _a.$colsVisibility, $colsVisibility = _c === void 0 ? [] : _c;
        var rowInRange = isSpanVisible($rowsVisibility, [positions.yStart, positions.yEnd], [topSplit, bottomSplit], data.length);
        var colInRange = isSpanVisible($colsVisibility, [positions.xStart, positions.xEnd], [leftSplit, rightSplit], columns.length);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(19), __webpack_require__(64).setImmediate))
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.normalizeCell = exports.getReducedColspan = exports.getHeight = exports.getWidth = void 0;
...
var main_1 = __webpack_require__(6);
var types_1 = __webpack_require__(3);
var editors_1 = __webpack_require__(81);
var html_1 = __webpack_require__(2);
var data_1 = __webpack_require__(7);
...
function getSpans(config, mode) {
    var _a, _b;
    var spanCells = [];
    var columns = config.columns, filteredColumns = config.filteredColumns, data = config.data, rSpans = config.currentSpans, bottomSplit = config.bottomSplit;
    ...
    var _loop_1 = function (i) {
        ...
        var rColIndex = columns === null || columns === void 0 ? void 0 : columns.findIndex(function (i) { return "".concat(i.id) === col; });
...
function normalizeSpan(span, config, data) {
    ...
    var rowIndexStart = data.getIndex(row);
    ...
    var fixedBottomByEnd = rowIndexEnd >= data.getLength() - bottomSplit;
    var rowsIndexVisibility = [rowIndexStart, rowIndexEnd];
    var colIndexVisibility = [colIndexStart, colIndexEnd];
    // if the span is not fully fixed
    if (colIndexEnd >= leftSplit &&
        rowIndexEnd >= topSplit &&
        colIndexStart < columns.length - rightSplit &&
        rowIndexStart < data.getLength() - bottomSplit) {
    ...
    return __assign(__assign({}, span), { $renderFrom: $renderFrom, $type: $type, $rowsVisibility: rowsIndexVisibility, $colsVisibility: colIndexVisibility });
}
    ...
    TreeGridCollection.prototype.serialize = function (driver) {
        ...
        _super.prototype.eachChild.call(this, this.getRoot(), function (el) {
            ...
            Object.keys(cell).forEach(function (key) {
                if (key.startsWith("$") && key !== "$groupName" && key !== "$level") {
                    delete cell[key];
                }
            });
            data.push(cell);
...
var loader_1 = __webpack_require__(68);
...
var columnsResizer_1 = __webpack_require__(111);
var keys_1 = __webpack_require__(112);
var FocusManager_1 = __webpack_require__(17);
var Cells_1 = __webpack_require__(16);
var Grid = /** @class */ (function (_super) {
    ...
    Grid.prototype._applyLocalFilter = function (beforePrepareData) {
        ...
        if (beforePrepareData) {
            this.data.filter(function (i) { return i; }, { $local: true }, true);
        }
        else {
    ...
    Grid.prototype._applyAutoWidth = function () {
        ...
        (0, render_1.applyAutoWidth)(this.config, parentSizes, true, false, scrollView);
    };
    return Grid;
}(view_1.View));
exports.Grid = Grid;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.dataDrivers = void 0;
__exportStar(__webpack_require__(60), exports);
var ts_data_1 = __webpack_require__(5);
Object.defineProperty(exports, "dataDrivers", { enumerable: true, get: function () { return ts_data_1.dataDriversPro; } });
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.i18n = exports.TreeGrid = exports.TreeGridCollection = exports.setTheme = exports.awaitRedraw = exports.cssManager = void 0;
__webpack_require__(61);
__webpack_require__(62);
// HELPERS
var CssManager_1 = __webpack_require__(63);
...
var TreeGridCollection_1 = __webpack_require__(30);
Object.defineProperty(exports, "TreeGridCollection", { enumerable: true, get: function () { return TreeGridCollection_1.TreeGridCollection; } });
// WIDGETS
var TreeGrid_1 = __webpack_require__(117);
Object.defineProperty(exports, "TreeGrid", { enumerable: true, get: function () { return TreeGrid_1.TreeGrid; } });
// TOOLS
var date_1 = __webpack_require__(13);
var en_1 = __webpack_require__(29);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(19), __webpack_require__(66)))
...
var CollectionStore_1 = __webpack_require__(114);
var types_1 = __webpack_require__(9);
var helpers_1 = __webpack_require__(10);
var core_1 = __webpack_require__(0);
...
var types_1 = __webpack_require__(3);
var InputEditor_1 = __webpack_require__(82);
var SelectEditor_1 = __webpack_require__(83);
var DateEditor_1 = __webpack_require__(84);
...
var dom_1 = __webpack_require__(1);
var types_1 = __webpack_require__(3);
var ts_calendar_1 = __webpack_require__(85);
var date_1 = __webpack_require__(13);
var ts_popup_1 = __webpack_require__(27);
...
var data_1 = __webpack_require__(7);
var core_1 = __webpack_require__(0);
var ComboFilter_1 = __webpack_require__(108);
var SelectFilter_1 = __webpack_require__(109);
var InputFilter_1 = __webpack_require__(110);
function parseItemValue(column, item) {
    ...
    if (column.editorType === "combobox") {
        ...
        return parseFloat(option ? option.value : value);
    }
    else if (column.editorType === "multiselect") {
        return NaN;
    }
...
var ts_data_1 = __webpack_require__(5);
var TreeGridCollection_1 = __webpack_require__(30);
var types_1 = __webpack_require__(118);
var defaultGroupTemplate = function (groupName, group) {
    return "".concat(groupName || "", " (").concat(group.length, ")");
};
var groupRender = function (row, config) {
    return (0, ts_grid_1.getTreeCell)(config.groupTitleTemplate(row.$groupName, row.items), row, { id: "$groupName", $width: "100%", $cellCss: {} }, config);
};
var TreeGrid = /** @class */ (function (_super) {
    ...
    TreeGrid.prototype.scrollTo = function (rowId, colId) {
        ...
        var prevColInd = (0, core_1.findIndex)(columns, function (obj) { return obj.id == prevCol.id; });
        var fixedColsWidth = this.config.leftSplit
            ? (0, ts_grid_1.getTotalWidth)(columns.slice(0, this.config.leftSplit))
            : 0;
        var x = (0, ts_grid_1.getTotalWidth)(columns.slice(0, colInd)) - (colInd - prevColInd < 0 ? fixedColsWidth : 0);
    ...
    TreeGrid.prototype.groupBy = function (property) {
        ...
        this.data.filter({}, { $restore: true }, true);
    ...
    TreeGrid.prototype.getCellRect = function (rowId, colId) {
        ...
        return {
            x: x,
            y: y,
            height: (span === null || span === void 0 ? void 0 : span.rowspan) ? (0, ts_grid_1.getHeight)(rows, span.rowspan, rowInd) : ((_a = rows[rowInd]) === null || _a === void 0 ? void 0 : _a.$height) || 0,
            width: (span === null || span === void 0 ? void 0 : span.colspan)
                ? (0, ts_grid_1.getWidth)(this.config.columns, span.colspan, (0, core_1.findIndex)(this.config.columns, function (item) { return item.id === span.column; }))
            ...
            if (data) {
                for (var _m = 0, _o = Object.entries(data); _m < _o.length; _m++) {
                    ...
                    var offset = ((_e = totalCols[0]) === null || _e === void 0 ? void 0 : _e.id) === key
                        ? this.data.getMaxLevel() * 24 + HORIZONTAL_OFFSET
                        : HORIZONTAL_OFFSET;
    ...
    TreeGrid.prototype._setEventHandlers = function () {
        ...
        this.data.events.on(ts_data_1.DataEvents.change, function (id, status, obj) {
            if (status === "update" && _this._pregroupData) {
                var item_1 = _this._pregroupData.find(function (item) { return item.id === id; });
                if (!item_1)
                    return;
                Object.keys(obj).forEach(function (key) {
                    if (key !== "parent" && !key.startsWith("$") && obj[key] !== item_1[key]) {
                        item_1[key] = obj[key];
                    }
                });
            }
